...
const columnData = [
	{ id: 'emp_id', numeric: false, disablePadding: true, label: 'ID' },
	{ id: 'first_name', numeric: false, disablePadding: true, label: 'Employee Name' },
	{ id: 'designation', numeric: false, disablePadding: true, label: 'Designation' },
	{ id: 'date_of_joining', numeric: false, disablePadding: true, label: 'Date Of Joining' },
	{ id: 'email', numeric: false, disablePadding: true, label: 'Email' },
	{ id: 'phone', numeric: false, disablePadding: true, label: 'Contact Number' },
	{ id: 'delete', numeric: false, disablePadding: true, label: 'Remove' },
	{ id: 'more', numeric: false, disablePadding: true, label: 'Edit' }
];
...
class EmployeeTable extends React.Component {
	...
	handleDelete = (event, employee) => {
		this.props.onDeleteUser(employee);
	};
					...
					<Table className={classes.table} aria-labelledby="tableTitle">
						...
						<TableBody>
							{data
								...
								.map((n) => {
									return (
										<TableRow hover role="checkbox" tabIndex={-1} key={n.ecb_id}>
											<TableCell>{n.id}</TableCell>
											<TableCell>{n.first_name + ' ' + n.last_name}</TableCell>
											<TableCell>{n.designation}</TableCell>
											<TableCell>{moment(n.date_of_joining).format('Do MMM YYYY')}</TableCell>
											...
											<TableCell>
												<IconButton
													...
													mini
													aria-label="Edit"
													onClick={(event) => this.handleDelete(event, n)}
												>
													<DeleteIcon />
												</IconButton>
											</TableCell>
