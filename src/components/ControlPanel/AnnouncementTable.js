...
const columnData = [
	...
	{ id: 'subject', numeric: false, disablePadding: true, label: 'Announcement Title' },
	{ id: 'content', numeric: false, disablePadding: false, label: 'Announcement' },
	{ id: 'more', numeric: false, disablePadding: false, label: 'Action' }
];

class AnnouncementTableHeader extends React.Component {
...
AnnouncementTableHeader.propTypes = {
