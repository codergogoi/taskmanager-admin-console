...
const columnData = [
	...
	{ id: 'title', numeric: false, disablePadding: true, label: 'Bonus Title' },
	...
	{ id: 'qualify_points', numeric: false, disablePadding: false, label: 'Qualify Points' },
	{ id: 'date', numeric: false, disablePadding: true, label: 'Date' },
	{ id: 'more', numeric: false, disablePadding: true, label: 'Action' }

];

class BonusTableHeader extends React.Component {
								...
								.map((n) => {
									return (
										...
										>
											...
											<TableCell>{n.conditions}</TableCell>
											<TableCell>{moment(n.deadline).format('Do MMM YYYY')}</TableCell>
											<TableCell>{n.qualify_points}</TableCell>
											<TableCell>{moment(n.date).format('Do MMM YYYY')}</TableCell>
											<TableCell>
												<IconButton className={classes.button} mini aria-label="Edit" onClick={() => this.handleDelete( n.id)}>
													<DeleteIcon />
												</IconButton>
											</TableCell>
										</TableRow>
...
export default withStyles(styles)(BonusTable);
