...
const columnData = [
	{ id: 'msg_title', numeric: false, disablePadding: true, label: 'Subject' },
	{ id: 'msg_desc', numeric: false, disablePadding: false, label: 'Description' },
	{ id: 'date', numeric: false, disablePadding: false, label: 'Date' },
	{ id: 'action', numeric: false, disablePadding: true, label: 'action' }
];

class MessagesTableHeader extends React.Component {
